...
/* "urh/dev/native/lib/cairspy.pxd":1
 * ctypedef unsigned char uint8_t             # <<<<<<<<<<<<<<
 * ctypedef short int16_t
 * ctypedef unsigned short uint16_t
 */
typedef unsigned char __pyx_t_3urh_3dev_6native_3lib_7cairspy_uint8_t;

/* "urh/dev/native/lib/cairspy.pxd":2
 * ctypedef unsigned char uint8_t
 * ctypedef short int16_t             # <<<<<<<<<<<<<<
 * ctypedef unsigned short uint16_t
 * ctypedef unsigned int uint32_t
 */
typedef short __pyx_t_3urh_3dev_6native_3lib_7cairspy_int16_t;

/* "urh/dev/native/lib/cairspy.pxd":3
 * ctypedef unsigned char uint8_t
 * ctypedef short int16_t
 * ctypedef unsigned short uint16_t             # <<<<<<<<<<<<<<
 * ctypedef unsigned int uint32_t
 ...
 */
typedef unsigned short __pyx_t_3urh_3dev_6native_3lib_7cairspy_uint16_t;

/* "urh/dev/native/lib/cairspy.pxd":4
 * ctypedef short int16_t
 * ctypedef unsigned short uint16_t
 * ctypedef unsigned int uint32_t             # <<<<<<<<<<<<<<
 * ctypedef unsigned long long uint64_t
 * 
 */
typedef unsigned int __pyx_t_3urh_3dev_6native_3lib_7cairspy_uint32_t;

/* "urh/dev/native/lib/cairspy.pxd":5
 * ctypedef unsigned short uint16_t
 * ctypedef unsigned int uint32_t
 * ctypedef unsigned long long uint64_t             # <<<<<<<<<<<<<<
 * 
 ...
 */
typedef unsigned PY_LONG_LONG __pyx_t_3urh_3dev_6native_3lib_7cairspy_uint64_t;
...
/* Module declarations from 'urh.dev.native.lib.cairspy' */
 ...
 */
      ...
      __pyx_t_7 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)(2 * __pyx_v_transfer->sample_count)));
      if (unlikely(!__pyx_t_8 || !__pyx_t_7 || !PyBytes_AsString(__pyx_t_8))) __PYX_ERR(0, 23, __pyx_L3_error)
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_GOTREF(__pyx_t_7);
      __pyx_t_6 = __pyx_array_new(__pyx_t_7, sizeof(float), PyBytes_AS_STRING(__pyx_t_8), (char *) "c", (char *) __pyx_t_5);
      ...
      __pyx_t_4 = (__pyx_t_7) ? __Pyx_PyObject_Call2Args(__pyx_t_8, __pyx_t_7, ((PyObject *)__pyx_t_6)) : __Pyx_PyObject_CallOneArg(__pyx_t_8, ((PyObject *)__pyx_t_6));
 ...
 */
    ...
    if (__pyx_t_9) {
      ...
      if (__Pyx_GetException(&__pyx_t_4, &__pyx_t_8, &__pyx_t_7) < 0) __PYX_ERR(0, 24, __pyx_L5_except_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_GOTREF(__pyx_t_7);
 ...
 * 
 */
        __Pyx_GetModuleGlobalName(__pyx_t_11, __pyx_n_s_logger); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 25, __pyx_L14_error)
        ...
        if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 25, __pyx_L14_error)
 ...
 * 
 */
      __pyx_t_3 = PyNumber_Add(__pyx_v_part, __pyx_kp_b__21); if (unlikely(!__pyx_t_3)) __PYX_ERR(2, 1482, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      ...
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_5 = PyNumber_Add(__pyx_t_6, __pyx_kp_b__21); if (unlikely(!__pyx_t_5)) __PYX_ERR(2, 1482, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_6 = PyNumber_Add(__pyx_t_5, __pyx_kp_b__22); if (unlikely(!__pyx_t_6)) __PYX_ERR(2, 1485, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 *             result = fmt.string
 */
      __pyx_t_6 = PyUnicode_Join(__pyx_kp_u__23, __pyx_v_extents); if (unlikely(!__pyx_t_6)) __PYX_ERR(2, 1490, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_airspy(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'airspy' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init urh.dev.native.lib.airspy", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
...
static CYTHON_INLINE enum airspy_error __Pyx_PyInt_As_enum__airspy_error(PyObject *x) {
    const enum airspy_error neg_one = (enum airspy_error) ((enum airspy_error) 0 - (enum airspy_error) 1), const_zero = (enum airspy_error) 0;
    const int is_unsigned = neg_one > const_zero;
#if PY_MAJOR_VERSION < 3
    if (likely(PyInt_Check(x))) {
