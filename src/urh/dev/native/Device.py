...
class Device(object):
    ...
    def read_receiving_queue(self):
        ...
        self.my_receive_buffer = IQArray(None, dtype=self.DATA_TYPE, n=int(my_num_samples))
        ...
        while self.is_receiving:
            ...
            if self.my_acess_record_iq:
                ...
                self.my_receive_buffer[self.my_current_recv_index:self.my_current_recv_index + n_samples] = samples[:n_samples]
