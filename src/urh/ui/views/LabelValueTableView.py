...
class LabelValueTableView(QTableView):
    ...
    def __init__(self, parent=None):
        ...
        self.del_rows_action = QAction("Видалити вибрані мітки", self)
    ...
    def create_context_menu(self):
        ...
        if self.model().rowCount() > 0 and min_row > -1:
            edit_label_action = menu.addAction(self.tr("Редагувати..."))
            ...
            if len(self.model().controller.proto_analyzer.message_types) > 1:
                msg_type_menu = menu.addMenu("Копіювати в тип повідомлення")
        ...
        menu.addSeparator()
        configure_field_types_action = menu.addAction("Конфігурувати типи полів...")
