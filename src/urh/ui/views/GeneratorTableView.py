...
class GeneratorTableView(TableView):
    ...
    def create_context_menu(self) -> QMenu:
        ...
        add_message_action = menu.addAction("Додати пусте повідомлення...")
        ...
        if self.model().row_count > 0:
            duplicate_action = menu.addAction("Дублювати виділені лінії")
            ...
            menu.addSeparator()
            clear_action = menu.addAction("Очистити таблицю")
    ...
    def on_add_message_action_triggered(self):
        ...
        num_bits, ok = QInputDialog.getInt(self, self.tr("Скільки бітів матиме нове повідомлення?"),
                                           self.tr("Кількість бітів:"), 42, 1)
        if ok:
