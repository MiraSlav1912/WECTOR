...
class MessageTypeTableView(QTableView):
    ...
    def __init__(self, parent):
        ...
        self.del_rows_action = QAction("Видалити виділені типи повідомлення", self)
    ...
    def create_context_menu(self):
        ...
        menu.addSeparator()
        show_all_action = menu.addAction("Показати всі типи повідомлень")
        show_all_action.triggered.connect(self.on_show_all_action_triggered)
        hide_all_action = menu.addAction("Приховати всі типи повідомлення")
