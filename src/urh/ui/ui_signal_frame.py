...
# Form implementation generated from reading ui file 'signal_frame.ui'
#
...
class Ui_SignalFrame(object):
    def setupUi(self, SignalFrame):
        ...
        self.spinBoxNoiseTreshold.hide()
        ...
        self.gridLayout_2.addWidget(self.spinBoxNoiseTreshold, 3, 1, 1, 1)
#-----

        self.cbProtoView = QtWidgets.QComboBox(SignalFrame)
        self.cbProtoView.hide()
        self.cbProtoView.setEnabled(True)
        ...
        self.gridLayout_2.addWidget(self.spinBoxCenterOffset, 4, 1, 1, 1)
        ...
        self.btnCloseSignal.setStyleSheet("background-color: red")
        icon = QtGui.QIcon.fromTheme("window-close")

        self.btnCloseSignal.setIcon(icon)
        self.btnCloseSignal.setObjectName("btnCloseSignal")
        self.gridLayout.addWidget(self.btnCloseSignal, 0, 5, 1, 1)
        ...
        self.lineEditSignalName.setMinimumSize(QtCore.QSize(500, 0))
        ...
        self.lineEditSignalName.setReadOnly(True)

        self.gridLayout.addWidget(self.lineEditSignalName, 0, 2, 1, 1)
        #
...
#------
        ...
        self.btnAdvancedModulationSettings.hide()
        ...
        self.gridLayout_2.addWidget(self.lCenterOffset, 4, 0, 1, 1)
        self.sliderSpectrogramMax = QtWidgets.QSlider(SignalFrame)
        self.sliderSpectrogramMax.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.sliderSpectrogramMin.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
#-------
        ...
        self.lSignalViewText.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
# -------
        ...
        self.gridLayout_2.addWidget(self.labelNoise, 3, 0, 1, 1)
        ...
        self.tableWidget = QtWidgets.QTableWidget(SignalFrame)
        ...
        self.tableWidget.setMinimumSize(200,200)
        ...
        self.tableWidget.setHorizontalHeaderLabels(("Назва", "Тип", "Частота", "Ширина спектру", "Тип модуляцii",
                                                    "ti, мкс", "Ti, мкс", "Коментар",
                                                    "Зображення", "Path"))
        self.tableWidget.setMouseTracking(True)

        for column_hidden in (0, 2, 3, 4, 7, 8, 9, 10):
            self.tableWidget.hideColumn(column_hidden)
        # self.tableWidget.setToolTip("Name")


        self.tableWidget.horizontalHeader().setSectionResizeMode(1)


        self.gridLayout_2.addWidget(self.tableWidget, 24, 0, 1, 2)
        self.chkBoxShowProtocol = QtWidgets.QCheckBox(SignalFrame)
        self.chkBoxShowProtocol.hide()
        self.chkBoxShowProtocol.setEnabled(True)
        ...
        self.sliderFFTWindowSize.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.cbSignalView.setEnabled(True)
        ...
        self.chkBoxSyncSelection.setEnabled(True)
        ...
        self.labelFFTWindowSize.setEnabled(True)
...
#-------
        ...
        self.labelSpectrogramMin.setEnabled(True)
        ...
        self.labelSpectrogramMax.setEnabled(True)
...
"}")
        ...
        self.lTextSelectedSamples.hide()
        ...
        self.dT = QtWidgets.QLabel(self.layoutWidget)
        self.dT.setToolTip("")
        self.dT.setObjectName("dT")
        self.horizontalLayout_3.addWidget(self.dT)
...
#------------------------------------------------------------------------------------------
        ...
        self.label_3 = QtWidgets.QLabel(SignalFrame)
        self.label_3.setObjectName("label_3")
        self.label_3.setFont(font)
        self.label_3.setStyleSheet("background-color:grey")
        self.horizontalLayout_3.addWidget(self.label_3)

        self.label_4 = QtWidgets.QLabel(SignalFrame)
...
# ------------------------------------------------------------------------------------------
        ...
        self.btnScreen = QtWidgets.QPushButton(SignalFrame)
        self.btnScreen.setObjectName("pushButton")
        icon = QtGui.QIcon.fromTheme("applets-screenshooter")
        self.btnScreen.setIcon(icon)
        self.horizontalLayout_3.addWidget(self.btnScreen)

        self.btnSetNoise = QtWidgets.QPushButton(SignalFrame)
        self.btnSetNoise.setObjectName("pushButton")
        icon = QtGui.QIcon.fromTheme("stock_filters")
        self.btnSetNoise.setIcon(icon)
        self.horizontalLayout_3.addWidget(self.btnSetNoise)
        ...
        self.horizontalLayout_3.addWidget(self.btnSaveSignal)

        self.label_5 = QtWidgets.QLabel(SignalFrame)
        self.label_5.setObjectName("label_5")
        self.horizontalLayout_3.addWidget(self.label_5)

        self.spin_proc = QtWidgets.QSpinBox(SignalFrame)
        self.spin_proc.setObjectName("spin_proc")
        self.spin_proc.setMinimum(1)
        self.spin_proc.setMaximum(30)
        self.spin_proc.setValue(5)
        self.spin_proc.setSingleStep(5)

        self.horizontalLayout_3.addWidget(self.spin_proc)
        ...
        self.pushButton = QtWidgets.QPushButton(SignalFrame)
        ...
        self.additionalInfos.addItem(spacerItem2)
...
#------
        ...
        self.pushButton_2 = QtWidgets.QPushButton(SignalFrame)
        self.pushButton_2.setObjectName("pushButton_2")
        self.pushButton_2.hide()
        self.gridLayout_2.addWidget(self.pushButton_2, 23, 1, 1, 1)
#-------
        ...
        # self.gridLayout_2.addItem(verticalSpacer)
    ...
    def retranslateUi(self, SignalFrame):
        ...
        #----
        self.pushButton.setText(_translate("SignalFrame", "Запис в БД"))
        self.pushButton_2.setText(_translate("SignalFrame", "Зберегти в "))
        #-----
        self.label_4.setText(_translate("SignalFrame", "0 мкс"))
        ...
        self.lErrorTolerance.setText(_translate("SignalFrame", "Допуск помилок"))
        ...
        self.lCenterOffset.setText(_translate("SignalFrame", "Центр"))
        ...
        self.lInfoLenText.setText(_translate("SignalFrame", "Довжина біта:"))
        self.lSignalViewText.setText(_translate("SignalFrame", "Вигляд сигналу:"))
        ...
        self.labelNoise.setText(_translate("SignalFrame", "Рівень шуму:"))
        ...
        self.btnAutoDetect.setText(_translate("SignalFrame", "Автоматизований аналіз сигналу"))
        self.labelModulation.setText(_translate("SignalFrame", "Модуляція:"))
        self.label_2.setText(_translate("SignalFrame", "0 мкс"))
...
"If you want your protocol to be better seperated, edit the PauseLen using right-click menu from a selection in SignalView or ProtocolView."))
        ...
        self.label_3.setText(_translate("SignalFrame", "Період слідування:"))
        ...
        self.label.setText(_translate("SignalFrame", "Тривалість імпульсу:"))
        ...
        self.dT.setText(_translate("SignalFrame", "Δt"))
        self.lDuration.setText(_translate("SignalFrame", "42 мкс"))
        ...
        self.btnSetNoise.setText(_translate("SignalFrame", "Встановити рівень шуму"))
        self.label_5.setText(_translate("SignalFrame", "Точнність пошуку, %"))
