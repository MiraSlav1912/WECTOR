...
"}")
        ...
        self.gridLayout.addWidget(self.pushButton_3, 18, 0, 1, 1)
        self.pushButton_4 = QtWidgets.QPushButton(self.frame_2)
        self.pushButton_4.setObjectName("pushButton_4")
        self.gridLayout.addWidget(self.pushButton_4, 18, 1, 1, 1)
    ...
    def retranslateUi(self, FormDeviceSettings):
        ...
        self.pushButton_2.setText(_translate("FormDeviceSettings", "PushButton"))
        self.pushButton.setText(_translate("FormDeviceSettings", "PushButton"))
        self.pushButton_3.setText(_translate("FormDeviceSettings", "PushButton"))
        self.pushButton_4.setText(_translate("FormDeviceSettings", "PushButton"))
