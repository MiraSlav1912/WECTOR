...
# ---------------------------------------------------------------
        ...
        self.tab_my_monitor.setObjectName("tab_my_monitor")
        self.verticalLayout_71 = QtWidgets.QVBoxLayout(self.tab_my_monitor)
        self.verticalLayout_71.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_71.setObjectName("verticalLayout_71")
        # self.tabWidget.addTab(self.tab_my_monitor, "")

        self.tab_my_spec = QtWidgets.QWidget()
        self.tab_my_spec.setObjectName("my_spec")
        self.my_Layout_2 = QtWidgets.QVBoxLayout(self.tab_my_spec)
        self.my_Layout_2.setContentsMargins(0, 0, 0, 0)
        self.my_Layout_2.setObjectName("my_Layout")
        self.tabWidget.addTab(self.tab_my_spec, "")
        ...
        self.my_Layout_3 = QtWidgets.QVBoxLayout(self.tab_bd)
        self.my_Layout_3.setContentsMargins(0, 0, 0, 0)
        self.my_Layout_3.setObjectName("my_Layout")
        self.tabWidget.addTab(self.tab_bd, "")

        self.tab_comutator = QtWidgets.QWidget()
        self.tab_comutator.setObjectName("tab_comutator")
        self.verticalLayout_2 = QtWidgets.QGridLayout(self.tab_comutator)
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.setSpacing(0)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        # self.tabWidget.addTab(self.tab_comutator, "Налаштування")
...
# ---------------------------------------------------------------
        ...
        # --------------------------------------------------------------
        self.my_Layout = QtWidgets.QVBoxLayout(self.layoutWidget)
        self.my_Layout.setObjectName("my_Layout")
        #-----------------------------------------------------------------
        ...
        self.lnEdtTreeFilter.setVisible(False)

        self.horizontalLayout_34 = QtWidgets.QVBoxLayout(self.layoutWidget)
        ...
        self.btnFileTreeGoUp.setVisible(False)
        ...
        self.fileTree.setVisible(False)
        ...
        self.labelNonProjectMode = QtWidgets.QLabel(self.splitter)
        ...
        self.actionSpectrum_Analyzer.setIconVisibleInMenu(False)
        ...
        self.tab_interpretation.setVisible(False)
        self.tab_generator.setVisible(False)
        self.tab_protocol.setVisible(False)
        self.tabWidget_Project.indexOf(self.tabParticipants)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "Програмний додаток до ЕЗ ВЕКТОР"))
        self.lnEdtTreeFilter.setPlaceholderText(_translate("MainWindow", "Фильтр"))
        ...
        # ---------------------------------------
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_my_monitor), _translate("MainWindow", "Моніторинг"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_my_spec),
                                  _translate("MainWindow", "Спектр"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_interpretation),_translate("MainWindow", "Тонка оцінка"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_bd),
                                  _translate("MainWindow", "Робота з базою"))
        # ---------------------------------------
        ...
        self.menuImport.setTitle(_translate("MainWindow", "Імпорт"))
        self.menuEdit.setTitle(_translate("MainWindow", "Редагування"))
        self.menuHelp.setTitle(_translate("MainWindow", "Допомога"))
        self.actionFSK.setText(_translate("MainWindow", "Назад"))
        self.actionOOK.setText(_translate("MainWindow", "Вперед"))
        ...
        self.actionTest.setText(_translate("MainWindow", "тест"))
        self.actionHold_Shift_to_Drag.setText(_translate("MainWindow", "&Hold Shift to Drag"))
        self.actionDocumentation.setText(_translate("MainWindow", "&Документація"))
        self.actionAbout_AutomaticHacker.setText(_translate("MainWindow", "&Про ВЕКТОР..."))
        self.actionOpenSignal.setText(_translate("MainWindow", "&Signal"))
        self.actionOpenProtocol.setText(_translate("MainWindow", "&Protocol"))
        self.actionShow_Compare_Frame.setText(_translate("MainWindow", "Show &Порівняння фреймів(кадрів)"))
        self.actionCloseAllFiles.setText(_translate("MainWindow", "&Приховати всі фільтри"))
        self.actionSaveAllSignals.setText(_translate("MainWindow", "&Зберегти всі сигнали"))
        self.actionSeperate_Protocols_in_Compare_Frame.setText(_translate("MainWindow", "Seperate &Protocols in Compare Frame"))
        self.actionOpenArchive.setText(_translate("MainWindow", "&Архів"))
        self.actionOpen.setText(_translate("MainWindow", "&Відкрити..."))
        self.actionOpen_Folder.setText(_translate("MainWindow", "Open &Папка.."))
        self.actionShow_only_Compare_Frame.setText(_translate("MainWindow", "Show Compare Frame only"))
        self.actionConfigurePlugins.setText(_translate("MainWindow", "конфігурація..."))
        ...
        self.actionDecoding.setText(_translate("MainWindow", "&Декодування..."))
        self.actionRecord.setText(_translate("MainWindow", "&Запис сигналу..."))
        self.actionSpectrum_Analyzer.setText(_translate("MainWindow", "Аналізатор спектру..."))
        self.actionOptions.setText(_translate("MainWindow", "&Опції..."))
        self.actionNew_Project.setText(_translate("MainWindow", "&Новий проект.."))
        self.actionSniff_protocol.setText(_translate("MainWindow", "Sn&iff protocol..."))
        self.actionProject_settings.setText(_translate("MainWindow", "&Налаштування проекту..."))
        self.actionSave_project.setText(_translate("MainWindow", "Збереження проекту"))
        self.actionFullscreen_mode.setText(_translate("MainWindow", "&Повноекранний режим"))
        self.actionOpen_directory.setText(_translate("MainWindow", "Відкрити з папки..."))
        self.actionAbout_Qt.setText(_translate("MainWindow", "Про &Qt"))
        self.actionShowFileTree.setText(_translate("MainWindow", "&Показати дерево файлів"))
        self.actionSamples_from_csv.setText(_translate("MainWindow", "імпорт IQ в csv"))
        self.actionClose_project.setText(_translate("MainWindow", "Закрити проект"))
        self.actionAuto_detect_new_signals.setText(_translate("MainWindow", "Автоматичне завантаження сигналу"))
